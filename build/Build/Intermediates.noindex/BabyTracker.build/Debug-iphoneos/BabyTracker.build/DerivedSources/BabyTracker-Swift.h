...
#ifndef BABYTRACKER_SWIFT_H
#define BABYTRACKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BabyTracker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11BabyTracker18NapReminderService")
@interface NapReminderService : NSObject <UNUserNotificationCenterDelegate>
...
SWIFT_CLASS("_TtC11BabyTracker17VoiceMemoRecorder")
@interface VoiceMemoRecorder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVAudioPlayer;
@interface VoiceMemoRecorder (SWIFT_EXTENSION(BabyTracker)) <AVAudioPlayerDelegate>
